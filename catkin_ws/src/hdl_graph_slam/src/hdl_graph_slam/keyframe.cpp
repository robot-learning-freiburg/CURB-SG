...
namespace hdl_graph_slam {
    ...
    KeyFrame::KeyFrame(const ros::Time &stamp, const int id, const Eigen::Isometry3d &odom, double accum_distance,
                       const pcl::PointCloud<PointT>::ConstPtr &cloud) : stamp(stamp), keyframe_id(id), odom(odom),
                                                                         accum_distance(accum_distance), cloud(cloud),
                                                                         node(nullptr) {}
